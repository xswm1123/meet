...
- (NSArray *)defaultCells {
    _homePageCell=[[UITableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"ce"];
    _homePageCell.textLabel.text=@"个人主页";
    _homePageCell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;
    ...
    //拉黑
    UITableViewCell * blackCell=[[UITableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cb"];
    blackCell.textLabel.text=@"拉入黑名单";
    blackCell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;
    //举报
    UITableViewCell * jCell=[[UITableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"jb"];
    jCell.textLabel.text=@"举报";
    jCell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;
    
    
    
    NSArray *_defaultCells = @[_homePageCell, _cell_newMessageNotify, cell_clearHistory ,blackCell,jCell];
