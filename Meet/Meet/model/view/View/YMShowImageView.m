...
- (void)configScrollViewWith:(NSInteger)clickTag andAppendArray:(NSArray *)appendArray{
    ...
    _scrollView.contentSize = CGSizeMake(self.frame.size.width * appendArray.count, self_Frame.size.height);
...
//        imageView.image = img;
        [imageView sd_setImageWithURL:[NSURL URLWithString:[appendArray objectAtIndex:i]] placeholderImage:nil];
