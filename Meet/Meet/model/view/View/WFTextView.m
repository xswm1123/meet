...
- (NSAttributedString *)createAttributedEmotionStringWithRanges:(NSArray *)ranges
    ...
    [attrString addAttribute:(id)kCTForegroundColorAttributeName value:(id)([UIColor lightGrayColor].CGColor) range:NSMakeRange(0,[attrString length])];
    
    if (_textColor == nil) {
        _textColor =iconYellow;
    }
